...
export default function ResumePage() {
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-background pb-24 font-sans text-white sm:pb-32">
      <Navbar />
      
      {/* Massive Ambient Orange Glow to blend perfectly with the main site */}
      <div className="pointer-events-none fixed left-[-25%] top-[-10%] z-0 h-[min(1000px,120vw)] w-[min(1000px,120vw)] rounded-full bg-[#F97316]/15 blur-[140px] sm:left-[-10%] sm:blur-[250px]" />
      <div className="pointer-events-none fixed bottom-0 right-[-25%] z-0 h-[min(800px,110vw)] w-[min(800px,110vw)] rounded-full bg-[#F97316]/10 blur-[140px] sm:right-[-10%] sm:blur-[250px]" />
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-5 pt-28 sm:px-8 md:px-12">
        
        {/* Header Section */}
        <div className="mb-16">
          <h1 className="mb-2 text-4xl font-bold tracking-tight drop-shadow-md sm:text-5xl md:text-7xl">Pranay Dumbhare</h1>
          <p className="mb-6 font-mono text-base font-bold uppercase tracking-widest text-[#F97316] sm:text-xl">Software Engineer</p>
          
          <div className="flex flex-wrap gap-4 text-sm font-medium items-center">
            <a href="tel:+917744024976" title="+91 7744024976" aria-label="Call Pranay" className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/[0.02] backdrop-blur-md transition-all hover:border-[#F97316]/50 hover:bg-white/10">
              <span className="text-[#F97316] text-lg">📞</span>
            </a>
            <a href="mailto:pranaydumbhare1006@gmail.com" title="pranaydumbhare1006@gmail.com" aria-label="Email Pranay" className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/[0.02] backdrop-blur-md transition-all hover:border-[#F97316]/50 hover:bg-white/10">
              <span className="text-[#F97316] text-lg">✉️</span>
            </a>
            <a href="https://www.linkedin.com/in/pranay-dumbhare/" target="_blank" rel="noopener noreferrer" aria-label="Pranay on LinkedIn" className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/[0.02] text-[#F97316] backdrop-blur-md transition-all hover:border-[#F97316]/50 hover:bg-white/10">
            ...
            <a href="https://github.com/pranay10062000" target="_blank" rel="noopener noreferrer" aria-label="Pranay on GitHub" className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/[0.02] text-[#F97316] backdrop-blur-md transition-all hover:border-[#F97316]/50 hover:bg-white/10">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="w-full sm:ml-4 sm:w-auto">
              <a 
                href="/assets/Pranay_Dumbhare_Java_Backend_Developer.pdf"
                download="Pranay_Dumbhare_Java_Backend_Developer.pdf"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="space-y-8">
            <div className="relative rounded-3xl border border-dashed border-[#F97316]/30 bg-black/40 p-6 shadow-2xl backdrop-blur-md transition-colors hover:border-[#F97316]/80 sm:p-8">
              {/* Sticker */}
